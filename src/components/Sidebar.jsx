...
import { ArrowDropDown, Add, Brightness4, Brightness7 } from '@mui/icons-material';
...
export const Sidebar = ({
  ...
  <div className="sessions-list">
    {Object.keys(chats).reverse().map(sessionId => {
      ...
      const timestamp = new Date(Number(sessionId.split('-')[1])).toLocaleTimeString([], { 
        hour: '2-digit', 
        minute: '2-digit' 
      });
        ...
        >
          ...
          >
            <div className="flex items-center gap-3 p-2">
              <div className="session-icon-container shrink-0">
                <div 
                  className="session-icon flex items-center justify-center rounded-[4px]"
                  style={{ 
            ...
            <button 
              className="delete-session absolute right-2 top-1/2 -translate-y-1/2 bg-white bg-opacity-70 rounded-full w-5 h-5 flex items-center justify-center text-xs hover:bg-opacity-100 transition-all shadow-sm"
              onClick={(e) => {
                e.stopPropagation();
